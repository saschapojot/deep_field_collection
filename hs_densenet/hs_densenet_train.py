...
out_model_Dir=f"./out_model_hs_densenet_L{L}_K{K}_r{r}_layer{num_layers}/growth_rate{growth_rate}/"
...
# Save the model
torch.save(model.state_dict(), out_model_Dir + f"/growth_rate{growth_rate}_hs_densenet_model.pth")
