...
fileNameTrain=data_inDir+f"/hs{N_samples}.test.pkl"
...
# plt.title(f'Histogram of test set (Y_test) for classical Heisenberg system')
...
plt.tight_layout()
plt.savefig("Y_test_3_hs.png")
plt.savefig("Y_test_3_hs.svg")
plt.close()