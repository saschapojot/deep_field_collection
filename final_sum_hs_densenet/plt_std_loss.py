...
num_neurons_vec_layer0=np.array(in_df_layer0["neuron_num"])
std_loss_vec_layer0=np.array(in_df_layer0["std_loss"])
#data layer_num_vec[1]
num_neurons_vec_layer1=np.array(in_df_layer1["neuron_num"])
std_loss_vec_layer1=np.array(in_df_layer1["std_loss"])
#data layer_num_vec[2]
num_neurons_vec_layer2=np.array(in_df_layer2["neuron_num"])
...
plt.title("hensenberg final sum densenet, more neurons")
