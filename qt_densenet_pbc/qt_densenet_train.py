...
if (len(sys.argv)!=4):
    ...
    print("example: python qt_resnet_train.py  num_epochs C skip_num")
    exit(argErrCode)
...
decrease_over = 50
C=int(sys.argv[2])
skip_connection_num=int(sys.argv[3])
...
model=qt_densenet(
    ...
    skip_connection_num=skip_connection_num
).to(device)
...
out_model_dir=f"./out_model_data/N{N}/C{C}/layer{skip_connection_num+1}/"
