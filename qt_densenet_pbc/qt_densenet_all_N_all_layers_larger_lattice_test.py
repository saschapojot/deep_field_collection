...
from qt_densenet_structure import *
...
for N in N_vec:
    for layer in layer_all:
        ...
        in_model_file = in_model_dir + f"qt_densenet_trained_over50_epoch{num_epochs}_num_samples200000.pth"
        ...
        out_content = f"num_epochs={num_epochs}, MSE_loss={format_using_decimal(test_loss)}, std_loss={format_using_decimal(std_loss)}  N={N}, C={C}, layer={layer}, num_epochs={num_epochs}, pred_mean={pred_mean}, pred_std={pred_std}\n"
