...
print(f"set_epoch={set_epoch}, relative_acc_layer2={relative_acc_layer1}")
print(f"set_epoch={set_epoch}, relative_acc_layer3={relative_acc_layer2}")
print(f"set_epoch={set_epoch}, relative_acc_layer4={relative_acc_layer3}")
...
plt.scatter(C_vec,relative_acc_layer1,color="blue",marker="o",s=marker_size1,label=f"densenet, n={layer1}")
plt.plot(C_vec,relative_acc_layer1,color="blue",linestyle="dashed",linewidth=lineWidth1)


plt.scatter(C_vec,relative_acc_layer2,color="magenta",marker="^",s=marker_size1,label=f"densenet, n={layer2}")
plt.plot(C_vec,relative_acc_layer2,color="magenta",linestyle="dashed",linewidth=lineWidth1)

plt.scatter(C_vec,relative_acc_layer3,color="green",marker="s",s=marker_size1,label=f"densenet, n={layer3}")
