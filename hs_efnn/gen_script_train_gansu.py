...
def contents_to_bash(num_layers,num_neurons,file_index):
    ...
    contents = [
        ...
        "cd /public/home/hkust_jwliu_1/liuxi/Documents/pyCode/deep_field_collection/hs_efnn\n",
        f"python3 -u hs_efnn_train.py {L} {r} {num_layers} {num_neurons}\n",
        ]
