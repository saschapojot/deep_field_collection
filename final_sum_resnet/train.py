...
out_model_Dir=f"./out_model_final_sum_resnet_L{L}_K{K}_r{r}_layer{num_layers}/neuron{num_neurons}/"
...
# Save the model
torch.save(model.state_dict(), out_model_Dir + f"final_sum_resnet_model.pth")
