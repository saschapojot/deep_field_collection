...
def contents_to_bash(num_layers,num_neurons,file_index):
    ...
    contents = [
        ...
        "#SBATCH -p lzicnormal\n",
        "#SBATCH --mem=20GB\n",
        f"#SBATCH -o out_fs_resnet_layer{num_layers}_neuron{num_neurons}.out\n",
        f"#SBATCH -e out_fs_resnet_layer{num_layers}_neuron{num_neurons}.err\n",
        f"cd /public/home/hkust_jwliu_1/liuxi/Documents/pyCode/deep_field_collection/final_sum_resnet\n",
