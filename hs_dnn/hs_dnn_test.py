...
dirs_root=f"./out_model_hs_efnn_L{L}_K{K}_r{r}_layer{num_layers}/"
...
fileNameTest=data_inDir+f"/hs20000.test.pkl"
...
def load_one_model_performance(num_neurons,epoch_num,dir):
    model_file_name = dir + f"/hs_dnn_trained_epoch{epoch_num}.pth"
    # Create the model
    model=hs_dnn(
