...
outPath="./bashFiles_fs_qt_dnn_pbc/"
...
def contents_to_bash(layer,C,file_index):
    contents = [
        ...
        "#SBATCH -p lzicnormal\n",
        "#SBATCH --mem=40GB\n",
        f"#SBATCH -o out_train_fs_qt_dnn_layer{layer}_C{C}.out\n",
        f"#SBATCH -e out_train_fs_qt_dnn_layer{layer}_C{C}.err\n",
        "cd /public/home/hkust_jwliu_1/liuxi/Documents/pyCode/deep_field_collection/final_sum_qt_dnn\n",
    ...
    outBashName = out_chunk + f"/train_qt_dnn_pbc_layer{layer}_C{C}.sh"
