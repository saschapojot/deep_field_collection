...
#this script plots training log
# System Parameters
...
dirs_root=f"./out_model_hs_attn_L{L}_K{K}_r{r}_layer{num_layers}/"
...
def load_one_log(dir):
    log_fileName=dir+"/hs_attn_training_log.txt"
