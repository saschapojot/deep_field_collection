...
model=resnet_final_sum(num_spins=num_spins,num_layers=num_layers,num_neurons=num_neurons).double().to(device)
...
# Save the model
torch.save(model.state_dict(), out_model_Dir + f"/resnet_final_sum_model.pth")
