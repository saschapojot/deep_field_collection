...
class one_residual_block(nn.Module):
    def __init__(self,input_dim, output_dim, hidden_dim=None):
        super(one_residual_block,self).__init__()
...
class resnet_final_sum(nn.Module):
    def __init__(self, num_spins, num_layers, num_neurons):
        super(resnet_final_sum,self).__init__()
        ...
        for _ in range(num_layers):
            layers.append(one_residual_block(prev_dim,num_neurons))
