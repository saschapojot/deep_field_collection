...
#this script plots Y_test for efnn, 3-spin infinite-range model
L=15
K=455
r=3
layer_num=3

in_Y_test_file=f"./efnn_data/data_inf_range_model_L{L}_K_{K}_r{r}/inf_range.test.pkl"

with open(in_Y_test_file,"rb") as fptr:
...
plt.savefig(out_dir+f"/Y_test_L{L}_K_{K}_r{r}_layer{layer_num}.png")
plt.savefig(out_dir+f"/Y_test_L{L}_K_{K}_r{r}_layer{layer_num}.svg")
plt.close()
