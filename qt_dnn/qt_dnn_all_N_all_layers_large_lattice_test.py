...
for N in N_vec:
    for layer in layer_all:
        ...
        in_model_file = in_model_dir + f"dnn_qt_trained_over50_epoch{num_epochs}_num_samples200000.pth"
        ...
        out_content = f"num_epochs={num_epochs}, MSE_loss={format_using_decimal(test_loss)}, std_loss={format_using_decimal(std_loss)}  N={N}, C={C}, layer={step_num_after_S1}, pred_mean={pred_mean}, pred_std={pred_std},  num_params={num_params}\n"
