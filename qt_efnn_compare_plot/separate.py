...
#qt_efnn layer 1
line1 = plt.scatter(qt_efnn_N_vec, qt_efnn_relative_error_layer0, color="green", label="EFNN, 1 layer",s=marker_size2)
plt.plot(qt_efnn_N_vec, qt_efnn_relative_error_layer0, color="green", linestyle="dashed",linewidth=lineWidth2)
#qt_efnn layer 2
line2 = plt.scatter(qt_efnn_N_vec, qt_efnn_relative_error_layer1, color="darkgreen", label="EFNN, 2 layers",s=marker_size2)
plt.plot(qt_efnn_N_vec, qt_efnn_relative_error_layer1, color="darkgreen", linestyle="dashed",linewidth=lineWidth2)
#qt_efnn layer 3
line3 = plt.scatter(qt_efnn_N_vec, qt_efnn_relative_error_vec_layer2, color="limegreen", label="EFNN, 3 layers",s=marker_size2)
plt.plot(qt_efnn_N_vec, qt_efnn_relative_error_vec_layer2, color="limegreen", linestyle="dashed",linewidth=lineWidth2)


#qt_densenet
#qt_densenet layer 1
line4 = plt.scatter(qt_densenet_N_vec, qt_densenet_relative_error_layer1,marker="s", color="red", label="DenseNet, 1 layer",s=marker_size2)
plt.plot(qt_densenet_N_vec, qt_densenet_relative_error_layer1, color="red", linestyle="dashed", linewidth=lineWidth2)
#qt_densenet layer 2
line5 = plt.scatter(qt_densenet_N_vec, qt_densenet_relative_error_layer2,marker="s", color="darkred", label="DenseNet, 2 layers",s=marker_size2)
plt.plot(qt_densenet_N_vec, qt_densenet_relative_error_layer2, color="darkred", linestyle="dashed", linewidth=lineWidth2)
#qt_densenet layer 3
line6 = plt.scatter(qt_densenet_N_vec, qt_densenet_relative_error_layer3,marker="s", color="indianred", label="DenseNet, 3 layers",s=marker_size2)
plt.plot(qt_densenet_N_vec, qt_densenet_relative_error_layer3, color="indianred", linestyle="dashed", linewidth=lineWidth2)

#qt_resnet
#qt_resnet layer 1
line7 = plt.scatter(qt_resnet_N_vec, qt_resnet_relative_error_layer1,marker="^", color="purple", label="ResNet, 1 layer", s=marker_size2)
plt.plot(qt_resnet_N_vec, qt_resnet_relative_error_layer1, color="purple", linestyle="dashed", linewidth=lineWidth2)
#qt_resnet layer 2
line8 = plt.scatter(qt_resnet_N_vec, qt_resnet_relative_error_layer2,marker="^", color="darkmagenta", label="ResNet, 2 layers", s=marker_size2)
plt.plot(qt_resnet_N_vec, qt_resnet_relative_error_layer2, color="darkmagenta", linestyle="dashed", linewidth=lineWidth2)
#qt_resnet layer 3
line9 = plt.scatter(qt_resnet_N_vec, qt_resnet_relative_error_layer3,marker="^", color="mediumorchid", label="ResNet, 3 layers", s=marker_size2)
plt.plot(qt_resnet_N_vec, qt_resnet_relative_error_layer3, color="mediumorchid", linestyle="dashed", linewidth=lineWidth2)

#qt_dnn layer1
line10 = plt.scatter(qt_dnn_N_vec,qt_dnn_relative_error_layer1,marker="D", color="blue", label="DNN, 1 layer", s=marker_size2)
plt.plot(qt_dnn_N_vec,qt_dnn_relative_error_layer1,color="blue", linestyle="dashed")

#qt_dnn layer 2
line11 = plt.scatter(qt_dnn_N_vec,qt_dnn_relative_error_layer2,marker="D", color="darkblue", label="DNN, 2 layers", s=marker_size2)
plt.plot(qt_dnn_N_vec,qt_dnn_relative_error_layer2,color="darkblue", linestyle="dashed")

#qt_dnn layer 3
line12 = plt.scatter(qt_dnn_N_vec,qt_dnn_relative_error_layer3,marker="D", color="cornflowerblue", label="DNN, 3 layers", s=marker_size2)
...
# Create legend
handles = [line1, line2, line3, line4, line5, line6, line7, line8, line9, line10, line11, line12]
labels = ["EFNN, 1 layer", "EFNN, 2 layers", "EFNN, 3 layers",
          "DenseNet, 1 layer", "DenseNet, 2 layers", "DenseNet, 3 layers",
          "ResNet, 1 layer", "ResNet, 2 layers", "ResNet, 3 layers",
          "DNN, 1 layer", "DNN, 2 layers", "DNN, 3 layers"]

legend = ax_legend.legend(handles, labels, loc='center', ncol=3,
...
plt.tight_layout()
plt.savefig("./qt_efnn_vs_all_legend.png", bbox_inches='tight', dpi=300)
plt.savefig("./qt_efnn_vs_all_legend.svg", bbox_inches='tight')
plt.close()
