...
# =============================================================================
# Generate CSV tables for Relative Error per layer across C values
# =============================================================================

# Layer 1 (using layer0 variables)
df_layer1 = pd.DataFrame({
    "C_value": pd.Series(C_vec),
    "EFNN_relative_error": pd.Series(qt_efnn_relative_err_layer0),
    "DenseNet_relative_error": pd.Series(qt_densenet_relative_err_layer0),
    "ResNet_relative_error": pd.Series(qt_resnet_relative_err_layer0),
    "DNN_relative_error": pd.Series(qt_dnn_relative_err_layer0)
})
df_layer1.to_csv(f"./qt_C_relative_error_layer1_epoch{set_epoch}.csv", index=False)
print(f"Saved qt_C_relative_error_layer1_epoch{set_epoch}.csv")

# Layer 2 (using layer1 variables)
df_layer2 = pd.DataFrame({
    "C_value": pd.Series(C_vec),
    "EFNN_relative_error": pd.Series(qt_efnn_relative_err_layer1),
    "DenseNet_relative_error": pd.Series(qt_densenet_relative_err_layer1),
    "ResNet_relative_error": pd.Series(qt_resnet_relative_err_layer1),
    "DNN_relative_error": pd.Series(qt_dnn_relative_err_layer1)
})
df_layer2.to_csv(f"./qt_C_relative_error_layer2_epoch{set_epoch}.csv", index=False)
print(f"Saved qt_C_relative_error_layer2_epoch{set_epoch}.csv")

# Layer 3 (using layer2 variables)
df_layer3 = pd.DataFrame({
    "C_value": pd.Series(C_vec),
    "EFNN_relative_error": pd.Series(qt_efnn_relative_err_layer2),
    "DenseNet_relative_error": pd.Series(qt_densenet_relative_err_layer2),
    "ResNet_relative_error": pd.Series(qt_resnet_relative_err_layer2),
    "DNN_relative_error": pd.Series(qt_dnn_relative_err_layer2)
})
df_layer3.to_csv(f"./qt_C_relative_error_layer3_epoch{set_epoch}.csv", index=False)
print(f"Saved qt_C_relative_error_layer3_epoch{set_epoch}.csv")