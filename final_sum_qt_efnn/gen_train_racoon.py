...
outPath="./bashFiles_fs_qt_efnn_pbc/"
...
def contents_to_bash(layer,C,file_index):
    contents = [
        ...
        "#SBATCH -p CLUSTER\n",
        "#SBATCH --mem=40GB\n",
        f"#SBATCH -o out_train_fs_qt_efnn_layer{layer}_C{C}.out\n",
        f"#SBATCH -e out_train_fs_qt_efnn_layer{layer}_C{C}.err\n",
        "cd /home/cywanag/data/hpc/cywanag/liuxi/Document/pyCode/deep_field_collection/final_sum_qt_efnn\n",
