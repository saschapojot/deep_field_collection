...
#layer1
plt.scatter(N_vec,relative_error_layer1,color="blue",marker="o",s=marker_size1,label=f"efnn, n={layer1}")
plt.plot(N_vec,relative_error_layer1,color="blue",linestyle="dashed",linewidth=lineWidth1)


#layer 2
plt.scatter(N_vec,relative_error_layer2,color="magenta",marker="^",s=marker_size1,label=f"efnn, n={layer2}")
plt.plot(N_vec,relative_error_layer2,color="magenta",linestyle="dashed",linewidth=lineWidth1)


#layer 2
plt.scatter(N_vec,relative_error_layer3,color="green",marker="s",s=marker_size1,label=f"efnn, n={layer3}")
